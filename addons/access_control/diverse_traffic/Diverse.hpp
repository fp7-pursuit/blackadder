 ...
 */ 
class Diverse:public CommChannel{
	public:
		/**
		 * Constructor
		 ...
		 */
		 Diverse(std::string payloadRVSId,bool user_space, char bastrategy);
	...
	private:
		...
		/**
		 * a structure that is used to store publication, traffic type pairs
		 */
		 map<std::string,std::string> pubtype;
		 /**
		 * a structure that is used to store publication IDs, publisher
		 */
		 map<std::string, std::string > pubpub;
		 /**
		  * a structure that is used to store the lower level SIDs for channels
		  */
		  map<std::string, std::string > pubSId;
		  /**
		  * a structure that is used to store the lower level RIDs for channels
		  */
		  map<std::string, std::string > pubRId;
